...
abuzar_guests = ["saad", "farhan", "Ali"];
print("Hi "+abuzar_guests[0]+", "+abuzar_guests[1]+", "+abuzar_guests[2]+", You all are invited for Dinner at Tasty on coming Sunday.")
...
abuzar_guests = ["saad", "farhan", "Ali"];
print(abuzar_guests[1]+" Will not be able to join us for Dinner.")

abuzar_guests[1] = 'fassi';
print("Hi "+abuzar_guests[0]+", You are invited for Dinner at tasty on coming Sunday.")
print("Hi "+abuzar_guests[1]+", You are invited for Dinner at tasty on coming Sunday.")
print("Hi "+abuzar_guests[2]+", You are invited for Dinner at tasty on coming Sunday.")
...
abuzar_guests = ["Saad", "farhan", "Ali"];
abuzar_guests.insert(0, "fassi");
abuzar_guests.insert(2, "awon");
abuzar_guests.append("rehan");

print("I am erally sorry to announce that my booking for tasty is changed, now I can invite only two people")
removed1 = abuzar_guests.pop(0)
print("Hi "+removed1+", Sorry I can't invite you to dinner")
removed2 = abuzar_guests.pop(0)
print("Hi "+removed2+", Sorry I can't invite you to dinner")
removed3 = abuzar_guests.pop(0)
print("Hi "+removed3+", Sorry I can't invite you to dinner")
removed4 = abuzar_guests.pop(0)
print("Hi "+removed4+", Sorry I can't invite you to dinner\n")
print("Hi "+abuzar_guests[0]+", You are still invited for the Dinner")
print("Hi "+abuzar_guests[1]+", You are still invited for the Dinner")
